...
var eventTypeMap = map[string]interface{}{
	"repo:push":                    PushEvent{},
	"repo:fork":                    ForkEvent{},
	"repo:commit_comment_created":  CommitCommentCreatedEvent{},
	"repo:commit_status_created":   CommitStatusCreatedEvent{},
	"repo:commit_status_updated":   CommitStatusUpdatedEvent{},
...
func (wh *WebHooks) Handle(eventKey string, handler WebHookHandler) {
	wh.handlers[eventKey] = handler
}

func (wh *WebHooks) badRequest(w http.ResponseWriter, r *http.Request, msg string, p ...interface{}) {
